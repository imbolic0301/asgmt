...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<?> handleCustomException(BindException exception) {
        ...
        return CommonDto.exceptionResponseFrom(
                CustomExceptionTypes.INVALID_PARAMETER_FAILURE_MESSAGE.init(
    ...
    public ResponseEntity<?> handleException(HttpMessageNotReadableException exception) {
         if (exception.contains(JsonParseException.class)) {
            return CommonDto.exceptionResponseFrom(CustomExceptionTypes.INVALID_JSON_FAILURE_MESSAGE.init(
    ...
    public ResponseEntity<?> handleException(MethodArgumentNotValidException exception) {
        return CommonDto.exceptionResponseFrom(CustomExceptionTypes.INVALID_PARAMETER_FAILURE_MESSAGE
                .init(ServiceExceptionTypes.MISS_REQUIRED_PARAMETER.getResultMessage()));
    }
    ...
    private static void printAbout(Exception exception) {
        ...
        if(exception != null) {
            ...
            log.error(exceptionCanonicalName);
